...
#if defined(LSFG_VITA3K_STATIC_VULKAN_LOADER)
// Vita3K links NVK's loader entry point as a real C function. Keep this
// declaration identical to the one used by the renderer so LTO sees one
// entity rather than Dolphin's process-global function-pointer variable.
